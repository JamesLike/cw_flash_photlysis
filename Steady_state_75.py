...
dir = '/home/james/Desktop/tmpspectdat/1120'
dattime = np.loadtxt(dir + '7551_time_points.txt')
dat = np.loadtxt(dir + '7551_data.txt')
datwav = np.loadtxt(dir + '7551_wavelengths.txt')

skytime = np.loadtxt(dir + 'sk71_time_points.txt')
skydat = np.loadtxt(dir + 'sk71_data.txt')
skywav = np.loadtxt(dir + 'sk71_wavelengths.txt')
...
dat1 = trimsky(19, 605)
dat2 = trimsky(642, 1328)
dat3 = trimsky(1336, 1954)
